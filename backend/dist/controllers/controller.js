...
import { getTodosQuery, getTodoQuery, checkIfTodoExistsQuery, addTodoQuery, getTodoByTaskQuery, removeTodoQuery, } from "../queries/queries.js";
...
export const addTodo = (req, res) => {
    ...
    const isTaskDone = done !== null && done !== void 0 ? done : false;
